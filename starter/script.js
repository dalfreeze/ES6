...
// var Athlete5 = function(name, yearOfBirth, job, olympicsGames, medals) {
//     Person5.call(this, name, yearOfBirth, job);
//     this.olympicsGames = olympicsGames;
//     this.medals = medals;
// };

// Athlete5.prototype = Object.create(Person5.prototype); // sets Athlete prototype to Person5 prototype

// Athlete5.prototype.wonMedal = function(medal) {
//     if (medal) {
//         this.medals = this.medals + medal;
//     } else {
//         this.medals++;
//     };
...
// johnAthlete5.calculateAge(); // this works because now Athlete inherits anything Person5 has
// johnAthlete5.wonMedal(5);
...
// class Athlete6 extends Person6 { // how to create subclass
